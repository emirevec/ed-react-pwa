    ...
    return (
        <form className="max-w-screen-xl mx-auto px-4">
            ...
            <div className="relative">
                ...
                <input type="search" id={defaultSearch} className="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-teal-200 focus:border-teal-200 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search jeans, sneakers..." value={searchQuery} onChange={onInput} onKeyDown={onKeyDown} required/>
            </div>
        </form>
    )
}
