            ...
            {loading
                ? <div className="max-w-sm bg-gray-200 p-5 border border-gray-300 rounded-lg shadow dark:animate-pulse dark:bg-gray-800 dark:border-gray-700">
                    <div className="flex justify-center h-auto max-w-full mb-3 overflow-hidden rounded-t-lg">
                        <div className="w-full h-80 bg-gray-400 animate-pulse rounded-t-lg"></div> {/* Image Skeleton */}
                    </div>
                    <div className="w-36 h-10 mb-2 bg-gray-400 animate-pulse rounded-md"></div>
                    <div className="flex items-center justify-between">
                        <div className="w-36 h-8 mr-2 bg-gray-400 animate-pulse rounded-md"></div> {/* Button Skeleton */}
                        <div className="w-24 h-8 bg-gray-400 animate-pulse rounded-md"></div> {/* Price Skeleton */}
                    </div>
                </div>
